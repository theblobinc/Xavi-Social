...
// Multi-grid module system is vendored into this package so /xavi_social doesn't depend on
...
<?php if ($enableSPA) : ?>
	...
	<script>
		...
		// Keep the multi-grid API base so existing modules continue working.
		window.XAVI_API_BASE = window.XAVI_API_BASE || '/xavi_multi_grid';
	</script>
